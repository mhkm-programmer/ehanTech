...
const services = [
  {
    id: 1,
    name: "SPC Flooring",
    subtitle: "Stone Plastic Composite flooring — waterproof, durable & perfect for Qatar's climate.",
  ...
  },
  {
    id: 2,
    name: "Vinyl Flooring",
    subtitle: "Luxury vinyl tiles & planks for residential & commercial spaces.",
    icon: <FaLayerGroup size={40} />,
    gradient: "from-[#0b0c10] to-gray-800",
    link: "/vinyl-flooring-qatar",
    rating: 4.5,
    badge: "Popular",
  },
  {
    ...
    subtitle: "Premium wooden parquet flooring for elegant villas & offices.",
    icon: <FaThLarge size={40} />,
    gradient: "from-[#8A1538] to-[#5a0e24]",
    link: "/parquet-flooring-qatar",
    rating: 5,
    badge: "Premium",
  },
  {
    ...
    subtitle: "Broadloom & modular carpet tiles for hotels, offices & residences.",
    icon: <FaCrop size={40} />,
    gradient: "from-[#0b0c10] to-gray-800",
    link: "/carpet-installation-qatar",
    rating: 4.5,
  },
  {
    id: 5,
    name: "Wallpaper Installation",
    subtitle: "Premium wallpaper & wall covering installation for interiors.",
    icon: <FaImage size={40} />,
    gradient: "from-[#8A1538] to-[#5a0e24]",
    link: "/wallpaper-installation-qatar",
    rating: 5,
    badge: "Trending",
  },
  {
    id: 6,
    name: "Gypsum Ceiling",
    subtitle: "Decorative false ceilings with integrated LED lighting designs.",
  ...
  },
  {
    ...
    subtitle: "Lightweight gypsum partition walls for offices & commercial spaces.",
    icon: <FaWrench size={40} />,
    gradient: "from-[#8A1538] to-[#5a0e24]",
    link: "/gypsum-partition-qatar",
    rating: 4.5,
  },
  {
    id: 8,
    name: "Wall Panels",
    subtitle: "Decorative 3D wall panels, wainscoting & feature wall installations.",
    icon: <FaTint size={40} />,
    gradient: "from-[#0b0c10] to-gray-800",
    link: "/wall-panels-qatar",
    rating: 4.5,
    badge: "New",
  },
];
    ...
    <section className="relative py-16 px-4 sm:px-6 lg:px-12 bg-gray-50">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="text-center mb-12">
          <span className="text-[#8A1538] text-xs font-bold uppercase tracking-[0.25em]">Flooring & Interior</span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mt-4 mb-4">
            Flooring & Interior <span className="text-[#8A1538]">Finishing</span>
          </h2>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            Premium flooring solutions, gypsum ceilings, wallpapers, panels & partitions for residential and commercial projects across Qatar.
          </p>
        </div>
        ...
        <div className="text-center mt-14">
          <p className="text-gray-500 mb-4 text-sm">Need flooring or interior finishing?</p>
