...
const products = [
  {
    ...
    subtitle: "100% light-blocking for bedrooms, media rooms & hotels.",
    icon: <FaBed size={40} />,
    gradient: "from-[#8A1538] to-[#5a0e24]",
    link: "/blackout-curtains-qatar",
    rating: 5,
    badge: "Best Seller",
  },
  {
    ...
    subtitle: "Soft, cozy fabrics for a relaxing bedroom ambiance.",
    icon: <FaBed size={40} />,
    gradient: "from-[#0b0c10] to-gray-800",
    link: "/bedroom-curtains-qatar",
    rating: 4.5,
  },
  {
    id: 3,
    name: "Living Room Curtains",
    subtitle: "Stylish drapes that add sophistication to any space.",
    icon: <FaEye size={40} />,
    gradient: "from-[#8A1538] to-[#5a0e24]",
    link: "/living-room-curtains-qatar",
    rating: 5,
    badge: "Popular",
  },
  {
    ...
    subtitle: "Professional treatments for corporate offices.",
    icon: <FaBuilding size={40} />,
    gradient: "from-[#0b0c10] to-gray-800",
    link: "/office-curtains-qatar",
    rating: 4.5,
  },
  {
    id: 5,
    name: "Hotel Curtains",
    subtitle: "Premium fire-retardant curtains for hospitality.",
  ...
  },
  {
    id: 6,
    name: "Wave Curtains",
    subtitle: "Modern wave-pleat curtains with clean lines.",
    icon: <FaWindowRestore size={40} />,
    gradient: "from-[#0b0c10] to-gray-800",
    link: "/wave-curtains-qatar",
    rating: 4.5,
  },
  {
    id: 7,
    name: "Roller Blinds",
    subtitle: "Minimalist blinds for modern homes & offices.",
    icon: <FaBlind size={40} />,
    gradient: "from-[#8A1538] to-[#5a0e24]",
    link: "/roller-blinds-qatar",
    rating: 5,
    badge: "Trending",
  },
  {
    id: 8,
    name: "Venetian & Vertical Blinds",
    subtitle: "Adjustable blinds for any space.",
    icon: <FaSun size={40} />,
    gradient: "from-[#0b0c10] to-gray-800",
    link: "/venetian-blinds-qatar",
    rating: 4.5,
  },
];
    ...
    <section className="relative py-16 px-4 sm:px-6 lg:px-12 bg-gray-50">
      <div className="max-w-screen-xl mx-auto">
        <div className="text-center mb-12">
          <span className="text-[#8A1538] text-xs font-bold uppercase tracking-[0.25em]">Curtains & Blinds</span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mt-4 mb-4">
            Premium <span className="text-[#8A1538]">Curtains & Blinds</span>
          </h2>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">Custom curtains, blinds, and window treatments for homes, hotels & offices across Qatar.</p>
        </div>

        <Slider {...settings}>
          {products.map((product) => (
            <div key={product.id} className="px-4">
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:-translate-y-1.5 transition-all duration-300 relative group border border-gray-100">
                {product.badge && (
        ...
        <div className="text-center mt-14">
          <p className="text-gray-500 mb-4 text-sm">Need custom curtains or blinds?</p>
...
export default Curtains_Blinds;
