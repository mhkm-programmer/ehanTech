...
const services = [
  {
    ...
    subtitle: "Custom booth design & fabrication for trade shows, exhibitions & corporate events.",
  ...
  },
  {
    ...
    subtitle: "End-to-end stall fabrication with premium materials, lighting & branding.",
    icon: <FaRulerCombined size={40} />,
    gradient: "from-[#0b0c10] to-gray-800",
    link: "/exhibition-stall-fabrication-qatar",
    rating: 4.5,
    badge: "Popular",
  },
  {
    id: 3,
    name: "Kiosk Fabrication",
    subtitle: "Custom kiosks for shopping malls, exhibitions, and promotional events.",
    icon: <FaChair size={40} />,
    gradient: "from-[#8A1538] to-[#5a0e24]",
    link: "/kiosk-fabrication-qatar",
    rating: 5,
  },
  {
    id: 4,
    name: "Wedding Decoration",
    subtitle: "Luxury wedding stage setup, floral arrangements, lighting & décor.",
    icon: <FaGlassCheers size={40} />,
    gradient: "from-[#0b0c10] to-gray-800",
    link: "/wedding-decoration-qatar",
    rating: 5,
    badge: "Premium",
  },
  {
    id: 5,
    name: "Stage & Event Setup",
    subtitle: "Professional stage construction, AV setup, seating & event production.",
  ...
  {
    id: 6,
    name: "Event Lighting & Sound",
    subtitle: "LED lighting, sound systems, and AV equipment for events & conferences.",
  ...
  {
    id: 7,
    name: "Corporate Event MC & Hosting",
    subtitle: "Professional emcees, moderators, and event hosts for corporate gatherings.",
    icon: <FaMicrophone size={40} />,
    gradient: "from-[#8A1538] to-[#5a0e24]",
    link: "/events-exhibitions-qatar",
    rating: 4,
  },
  {
    id: 8,
    name: "Event Photography & Video",
    subtitle: "Professional photography and videography coverage for all events.",
    ...
    <section className="relative py-16 px-4 sm:px-6 lg:px-12 bg-gray-50">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="text-center mb-12">
          <span className="text-[#8A1538] text-xs font-bold uppercase tracking-[0.25em]">Events & Exhibitions</span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mt-4 mb-4">
            Events & <span className="text-[#8A1538]">Exhibitions</span>
          </h2>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            Full-service event production — exhibition booths, kiosks, wedding décor, stage setup, lighting, sound, and event management across Qatar.
          </p>
        </div>
        ...
        <div className="text-center mt-14">
          <p className="text-gray-500 mb-4 text-sm">Planning an event or exhibition?</p>
          <a
            href="https://wa.me/97450755702"
            target="_blank"
            rel="noopener noreferrer"
