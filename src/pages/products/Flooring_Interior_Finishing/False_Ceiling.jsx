...
const False_Ceiling = () => {
  return (
    <div className="font-sans text-gray-800 bg-white">
      <PageTitle title="False Ceiling | Ehan Tech Qatar" />

      {/* Hero */}
      <ParallaxSection
        imagePath="https://8upload.com/image/685c9a9746ecf/IMG-20250625-WA0038.jpg"
        title="False Ceiling Qatar"
        subTitle="Modern Ceilings. Premium Design. Delivered Across Qatar."
      />
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-4 mb-6 leading-tight">
          Expert False Ceiling <span className="text-[#8A1538]">in Qatar</span>
        </h2>
        <p className="text-gray-500 text-lg max-w-4xl mx-auto leading-relaxed">
          Ehan Tech provides complete false ceiling solutions in Qatar. We specialize in suspended ceilings, drop ceilings, grid ceilings, POP ceilings, and custom false ceiling designs for villas, offices, hotels, and commercial spaces.
        </p>
      </section>
      ...
      <section className="bg-[#f9f5f0] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          {[
            { icon: <FaBorderAll size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Suspended Ceilings", desc: "Grid suspended ceilings for commercial & office spaces." },
            { icon: <FaLightbulb size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "LED Integration", desc: "Recessed LED panel lighting in false ceilings." },
            { icon: <FaPaintRoller size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "POP Ceilings", desc: "Plaster of Paris decorative false ceilings." },
            { icon: <FaHammer size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Drop Ceilings", desc: "Drop ceilings for concealed wiring & ductwork." },
            ...
            { icon: <FaRulerCombined size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Design", desc: "Bespoke false ceiling designs for any space." },
            { icon: <FaShieldAlt size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Fire Rated", desc: "Fire-resistant ceiling materials for safety." },
            { icon: <FaHardHat size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Ceiling Repair", desc: "False ceiling repair & restoration services." },
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mt-4">False Ceiling Services</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {["Suspended Ceilings","Drop Ceilings","Grid Ceilings","POP Ceilings","Gypsum False Ceilings","LED Panel Installation","Villa False Ceilings","Office False Ceilings","Hotel False Ceilings","Commercial False Ceilings","Bathroom False Ceilings","Kitchen False Ceilings","Ceiling Repair","Ceiling Replacement","Cornice Installation","Molding Installation","Ceiling Painting","False Ceiling Consultation"].map((s, i) => (
      ...
      <section className="bg-gradient-to-br from-[#8A1538] to-[#5a0e24] py-20 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Need False Ceiling in Qatar?</h2>
