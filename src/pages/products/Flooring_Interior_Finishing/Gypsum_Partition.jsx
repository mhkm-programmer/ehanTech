...
const Gypsum_Partition = () => {
  return (
    <div className="font-sans text-gray-800 bg-white">
      <PageTitle title="Gypsum Partition | Ehan Tech Qatar" />

      {/* Hero */}
      <ParallaxSection
        imagePath="https://8upload.com/image/685c9a9746ecf/IMG-20250625-WA0038.jpg"
        title="Gypsum Partition Qatar"
        subTitle="Flexible Spaces. Strong Walls. Delivered Across Qatar."
      />
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-4 mb-6 leading-tight">
          Expert Gypsum Partition <span className="text-[#8A1538]">in Qatar</span>
        </h2>
        <p className="text-gray-500 text-lg max-w-4xl mx-auto leading-relaxed">
          Ehan Tech provides complete gypsum partition solutions in Qatar. We specialize in lightweight partition walls, drywall partitions, fire-rated partitions, and custom partition systems for offices, commercial spaces, and residential properties.
        </p>
      </section>
      ...
      <section className="bg-[#f9f5f0] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          {[
            { icon: <FaBorderAll size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Drywall Partitions", desc: "Lightweight drywall partitions for flexible spaces." },
            { icon: <FaCrop size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Fire-Rated Partitions", desc: "Fire-resistant gypsum partitions for safety compliance." },
            { icon: <FaThLarge size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Office Partitions", desc: "Wall partitions for open-plan & private offices." },
            { icon: <FaHammer size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Room Dividers", desc: "Gypsum room dividers for flexible space management." },
            { icon: <FaBuilding size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Commercial Partitions", desc: "Partition walls for retail, hotels & commercial use." },
            ...
            { icon: <FaRulerCombined size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Design", desc: "Bespoke partition walls for any space." },
            { icon: <FaShieldAlt size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Soundproof", desc: "Acoustic-rated partitions for noise reduction." },
            { icon: <FaHardHat size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Partition Repair", desc: "Gypsum partition repair & modification." },
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mt-4">Gypsum Partition Services</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {["Drywall Partitions","Fire-Rated Partitions","Soundproof Partitions","Office Partitions","Room Dividers","Meeting Room Walls","Commercial Partitions","Retail Partitions","Hotel Partitions","Residential Partitions","Villa Partitions","Custom Partitions","Partition Repair","Partition Modification","Corner Bead Installation","Joint Taping","Surface Finishing","Partition Consultation"].map((s, i) => (
      ...
      <section className="bg-[#f9f5f0] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 max-w-3xl mx-auto mb-10">Quality gypsum partitions, expert installation and professional service.</p>
      ...
      <section className="bg-gradient-to-br from-[#8A1538] to-[#5a0e24] py-20 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Need Gypsum Partitions in Qatar?</h2>
...
export default Gypsum_Partition;
