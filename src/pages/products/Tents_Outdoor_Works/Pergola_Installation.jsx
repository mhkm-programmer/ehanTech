...
const Pergola_Installation = () => {
  return (
    <div className="font-sans text-gray-800 bg-white">
      <PageTitle title="Pergola Installation | Ehan Tech Qatar" />

      {/* Hero */}
      <ParallaxSection
        imagePath="https://8upload.com/image/685c9a9746ecf/IMG-20250625-WA0038.jpg"
        title="Pergola Installation Qatar"
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-4 mb-6 leading-tight">
          Expert Pergola Installation <span className="text-[#8A1538]">in Qatar</span>
        </h2>
        <p className="text-gray-500 text-lg max-w-4xl mx-auto leading-relaxed">
          Ehan Tech provides professional pergola installation services in Qatar. We specialize in wooden pergolas, aluminium pergolas, motorized louvered pergolas, garden pergolas, and custom outdoor structures for villas, gardens, restaurants, and commercial properties.
        </p>
      </section>
      ...
      <section className="bg-[#f9f5f0] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          {[
            ...
            { icon: <FaHammer size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Garden Pergolas", desc: "Beautiful garden pergolas for dining & lounging." },
            { icon: <FaLightbulb size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Integrated Lighting", desc: "Pergolas with built-in LED lighting & ceiling fans." },
            ...
            { icon: <FaShieldAlt size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Weather Resistant", desc: "Built to withstand Qatar's harsh climate conditions." },
            { icon: <FaHardHat size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Commercial Pergolas", desc: "Pergola systems for restaurants, cafes & hotels." },
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mt-4">Pergola Installation Services</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {["Wooden Pergolas","Aluminium Pergolas","Motorized Pergolas","Louvered Pergolas","Garden Pergolas","Poolside Pergolas","Patio Pergolas","Villa Pergolas","Restaurant Pergolas","Hotel Pergolas","Commercial Pergolas","Custom Pergolas","Pergola with Lights","Pergola with Fans","Pergola Repair","Pergola Maintenance","Pergola Removal","Outdoor Structure Consulting"].map((s, i) => (
      ...
      <section className="bg-[#f9f5f0] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 max-w-3xl mx-auto mb-10">Quality pergolas, expert installation and professional service.</p>
      ...
      <section className="bg-gradient-to-br from-[#8A1538] to-[#5a0e24] py-20 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Need Pergola Installation in Qatar?</h2>
...
export default Pergola_Installation;
