...
const Blackout_Curtains = () => {
  return (
    <div className="font-sans text-gray-800 bg-white">
      <PageTitle title="Blackout Curtains | Ehan Tech Qatar" />

      <ParallaxSection
        imagePath="https://8upload.com/image/685c9a9746ecf/IMG-20250625-WA0038.jpg"
        title="Blackout Curtains Qatar"
        subTitle="Total Darkness. Premium Comfort. Delivered Across Qatar."
      />

      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        <span className="text-[#8A1538] text-xs font-bold uppercase tracking-[0.25em]">Ehan Tech</span>
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-4 mb-6 leading-tight">
          Premium Blackout Curtains <span className="text-[#8A1538]">in Qatar</span>
        </h2>
        <p className="text-gray-500 text-lg max-w-4xl mx-auto leading-relaxed">
          Ehan Tech provides complete blackout curtain solutions in Qatar. We specialize in 100% light-blocking curtains, thermal insulated curtains, night curtains, and blackout drapes for bedrooms, media rooms, hotels, and commercial spaces.
        </p>
      </section>
      ...
      <section className="bg-[#f9f5f0] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          {[
            { icon: <FaMoon size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Total Blackout", desc: "100% light-blocking fabric for complete darkness." },
            { icon: <FaBed size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Bedroom Blackout", desc: "Perfect for bedrooms & nurseries." },
            { icon: <FaEyeSlash size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Media Room", desc: "Ideal for home theaters & media rooms." },
            { icon: <FaHotel size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Hotel Blackout", desc: "Premium blackout for hospitality." },
            { icon: <FaBuilding size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Commercial", desc: "Blackout solutions for offices & clinics." },
            { icon: <FaTools size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Made", desc: "Bespoke sizes & styles to order." },
            ...
            { icon: <FaShieldAlt size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Thermal Insulated", desc: "Energy-saving thermal backing." },
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mt-4">Blackout Curtain Services</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {["Total Blackout Curtains","Bedroom Blackout","Nursery Blackout","Media Room Blackout","Hotel Blackout","Office Blackout","Thermal Blackout","Blackout Linings","Blackout Drapes","Blackout Roller Blinds","Motorized Blackout","Custom Blackout","Blackout Repair","Track Installation","Rod Installation","Free Measurement","Free Consultation","Blackout Solutions"].map((s, i) => (
      ...
      <section className="bg-[#f9f5f0] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 max-w-3xl mx-auto mb-10">Quality blackout curtains, expert fitting and professional service.</p>
          <div className="grid md:grid-cols-4 gap-6">
            {[{title:"Free Measurement",desc:"No-cost site visit"},{title:"100% Blackout",desc:"Guaranteed darkness"},{title:"Premium Fabrics",desc:"Top quality materials"},{title:"Expert Fitting",desc:"Skilled installers"},{title:"On-Time Delivery",desc:"On schedule"},{title:"Fair Pricing",desc:"No hidden costs"},{title:"After-Service",desc:"Warranty support"},{title:"Fully Insured",desc:"Full coverage"}].map((item, i) => (
      ...
      <section className="bg-gradient-to-br from-[#8A1538] to-[#5a0e24] py-20 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Need Blackout Curtains in Qatar?</h2>
...
export default Blackout_Curtains;
