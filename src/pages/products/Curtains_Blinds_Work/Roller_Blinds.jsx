...
const Roller_Blinds = () => {
  return (
    <div className="font-sans text-gray-800 bg-white">
      <PageTitle title="Roller Blinds | Ehan Tech Qatar" />

      <ParallaxSection
        imagePath="https://8upload.com/image/685c9a9746ecf/IMG-20250625-WA0038.jpg"
        title="Roller Blinds Qatar"
        subTitle="Modern Blinds. Clean Design. Delivered Across Qatar."
      />

      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        <span className="text-[#8A1538] text-xs font-bold uppercase tracking-[0.25em]">Ehan Tech</span>
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-4 mb-6 leading-tight">
          Premium Roller Blinds <span className="text-[#8A1538]">in Qatar</span>
        </h2>
        <p className="text-gray-500 text-lg max-w-4xl mx-auto leading-relaxed">
          Ehan Tech provides complete roller blind solutions in Qatar. We specialize in blackout roller blinds, sunscreen blinds, motorized roller blinds, and custom roller blinds for homes, offices, hotels, and commercial spaces.
        </p>
      </section>
      ...
      <section className="bg-[#f9f5f0] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          {[
            { icon: <FaBlind size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Roller Blinds", desc: "Clean and minimal roller blinds for any space." },
            { icon: <FaEyeSlash size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Blackout Rollers", desc: "Total blackout roller blinds for bedrooms." },
            { icon: <FaSun size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Sunscreen Blinds", desc: "UV-blocking sunscreen roller blinds." },
            { icon: <FaWindowRestore size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Motorized Rollers", desc: "Smart motorized roller blinds with remote." },
            { icon: <FaBuilding size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Commercial Rollers", desc: "Heavy-duty roller blinds for offices." },
            { icon: <FaTools size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Made", desc: "Bespoke roller blinds to your size." },
            ...
            { icon: <FaShieldAlt size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Quality Fabrics", desc: "Premium roller blind materials." },
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mt-4">Roller Blind Services</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {["Roller Blinds","Blackout Roller Blinds","Sunscreen Roller Blinds","Motorized Roller Blinds","Remote Control Blinds","Smart Blinds","Battery Operated Blinds","Villa Roller Blinds","Office Roller Blinds","Hotel Roller Blinds","Custom Roller Blinds","Roller Blind Repair","Fabric Replacement","Chain Replacement","Motor Repair","Free Measurement","Free Consultation","Roller Blind Solutions"].map((s, i) => (
      ...
      <section className="bg-[#f9f5f0] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 max-w-3xl mx-auto mb-10">Quality roller blinds, expert fitting and professional service.</p>
          <div className="grid md:grid-cols-4 gap-6">
            {[{title:"Free Measurement",desc:"No-cost site visit"},{title:"Custom Made",desc:"Made to your size"},{title:"Quality Fabrics",desc:"Premium materials"},{title:"Expert Fitting",desc:"Skilled installers"},{title:"On-Time Delivery",desc:"On schedule"},{title:"Fair Pricing",desc:"No hidden costs"},{title:"After-Service",desc:"Warranty support"},{title:"Fully Insured",desc:"Full coverage"}].map((item, i) => (
      ...
      <section className="bg-gradient-to-br from-[#8A1538] to-[#5a0e24] py-20 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Need Roller Blinds in Qatar?</h2>
