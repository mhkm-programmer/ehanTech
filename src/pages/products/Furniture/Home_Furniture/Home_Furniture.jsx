...
const Home_Furniture = () => {
  return (
    <div className="font-sans text-gray-800 bg-white">
      <PageTitle title="Home Furniture | Ehan Tech Qatar" />

      <ParallaxSection
        imagePath="https://8upload.com/image/685c9a9746ecf/IMG-20250625-WA0038.jpg"
        title="Home Furniture Qatar"
        subTitle="Beautiful Homes. Premium Furniture. Delivered Across Qatar."
      />

      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        <span className="text-[#8A1538] text-xs font-bold uppercase tracking-[0.25em]">Ehan Tech</span>
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-4 mb-6 leading-tight">
          Premium Home Furniture <span className="text-[#8A1538]">in Qatar</span>
        </h2>
        <p className="text-gray-500 text-lg max-w-4xl mx-auto leading-relaxed">
          Ehan Tech provides complete home furniture solutions in Qatar. We specialize in living room sets, bedroom furniture, dining sets, sofas, beds, wardrobes, and custom home furniture for villas, apartments, and residences.
        </p>
      </section>
      ...
      <section className="bg-[#f9f5f0] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          {[
            { icon: <FaCouch size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Living Room Sets", desc: "Complete living room furniture including sofas & tables." },
            { icon: <FaBed size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Bedroom Furniture", desc: "Beds, wardrobes, nightstands & dressers." },
            { icon: <FaUtensils size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Dining Sets", desc: "Dining tables, chairs & sideboards for any space." },
            { icon: <FaCouch size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Sofa Sets", desc: "Premium L-shaped, sectional & classic sofas." },
            { icon: <FaLock size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Wardrobes", desc: "Built-in & freestanding wardrobes with custom storage." },
            { icon: <FaTable size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Coffee Tables", desc: "Stylish coffee tables & side tables." },
            { icon: <FaBoxOpen size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Storage Solutions", desc: "Cabinets, shelves & storage units." },
            { icon: <FaChair size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Accent Chairs", desc: "Elegant accent chairs for any room." },
            { icon: <FaHardHat size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Furniture", desc: "Bespoke furniture made to order." },
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mt-4">Home Furniture Services</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {["Living Room Sets","Bedroom Furniture","Dining Sets","Sofa Sets","Beds","Wardrobes","Cabinets","Coffee Tables","Side Tables","Accent Chairs","Storage Units","Bookshelves","TV Units","Entryway Furniture","Custom Furniture","Furniture Assembly","Furniture Repair","Home Styling"].map((s, i) => (
      ...
      <section className="bg-[#f9f5f0] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 max-w-3xl mx-auto mb-10">Quality home furniture, expert craftsmanship and professional service.</p>
      ...
      <section className="bg-gradient-to-br from-[#8A1538] to-[#5a0e24] py-20 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Need Home Furniture in Qatar?</h2>
