...
const Sofa_Sets = () => {
  return (
    <div className="font-sans text-gray-800 bg-white">
      <PageTitle title="Sofa Sets | Ehan Tech Qatar" />

      <ParallaxSection
        imagePath="https://8upload.com/image/685c9a9746ecf/IMG-20250625-WA0038.jpg"
        title="Sofa Sets Qatar"
        subTitle="Premium Comfort. Elegant Design. Delivered Across Qatar."
      />

      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        <span className="text-[#8A1538] text-xs font-bold uppercase tracking-[0.25em]">Ehan Tech</span>
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-4 mb-6 leading-tight">
          Premium Sofa Sets <span className="text-[#8A1538]">in Qatar</span>
        </h2>
        <p className="text-gray-500 text-lg max-w-4xl mx-auto leading-relaxed">
          Ehan Tech provides premium sofa set solutions in Qatar. We specialize in L-shaped sofas, sectional sofas, classic sofa sets, modern sofas, and custom upholstered sofas for living rooms, lounges, and commercial spaces.
        </p>
      </section>
      ...
      <section className="bg-[#f9f5f0] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          {[
            { icon: <FaCouch size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "L-Shaped Sofas", desc: "Corner sofas perfect for modern living rooms." },
            { icon: <FaChair size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Sectional Sofas", desc: "Modular sectional sofas for flexible seating." },
            { icon: <FaStar size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Classic Sofas", desc: "Traditional 3-seater & 2-seater sofa sets." },
            { icon: <FaCouch size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Modern Sofas", desc: "Contemporary designs for stylish interiors." },
            { icon: <FaBuilding size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Commercial Sofas", desc: "Heavy-duty sofas for hotels & lobbies." },
            { icon: <FaBoxOpen size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Upholstery", desc: "Bespoke sofa designs with fabric selection." },
            { icon: <FaLock size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Sofa Beds", desc: "Space-saving sofa bed combinations." },
            { icon: <FaRulerCombined size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Sizes", desc: "Made to fit your space perfectly." },
            { icon: <FaHardHat size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Expert Delivery", desc: "Professional delivery & placement." },
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mt-4">Sofa Set Services</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {["L-Shaped Sofas","Sectional Sofas","3-Seater Sofas","2-Seater Sofas","Sofa Beds","Modern Sofas","Classic Sofas","Corner Sofas","U-Shaped Sofas","Recliner Sofas","Fabric Sofas","Leather Sofas","Custom Sofas","Commercial Sofas","Hotel Sofas","Sofa Repair","Reupholstery","Sofa Cleaning"].map((s, i) => (
      ...
      <section className="bg-gradient-to-br from-[#8A1538] to-[#5a0e24] py-20 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Need Sofa Sets in Qatar?</h2>
