...
const Furniture = () => {
  return (
    <div className="font-sans text-gray-800 bg-white">
      <PageTitle title="Furniture | Ehan Tech Qatar" />

      <ParallaxSection
        imagePath="https://8upload.com/image/685c9a9746ecf/IMG-20250625-WA0038.jpg"
        title="Furniture Qatar"
        subTitle="Custom Furniture. Premium Quality. Delivered Across Qatar."
      />

      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        <span className="text-[#8A1538] text-xs font-bold uppercase tracking-[0.25em]">Ehan Tech</span>
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-4 mb-6 leading-tight">
          Premium Furniture Solutions <span className="text-[#8A1538]">in Qatar</span>
        </h2>
        <p className="text-gray-500 text-lg max-w-4xl mx-auto leading-relaxed">
          Ehan Tech provides complete furniture solutions in Qatar. We specialize in custom sofas, beds, wardrobes, home furniture, and office furniture.
        </p>
      </section>
      ...
      <section className="bg-[#f9f5f0] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          {[
            { icon: <FaCouch size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Sofa Sets", desc: "L-shaped, sectional & classic sofas tailored to your space." },
            { icon: <FaBed size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Beds", desc: "Handcrafted wooden & upholstered beds in all sizes." },
            { icon: <FaLock size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Wardrobes & Cabinets", desc: "Built-in & freestanding wardrobes." },
            { icon: <FaCouch size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Home Furniture", desc: "Sets for living, dining & bedroom." },
            { icon: <FaLaptop size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Office Furniture", desc: "Desks, chairs & workstations." },
            { icon: <FaTable size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Office Tables", desc: "Conference tables & reception desks." },
            { icon: <FaChair size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Office Chairs", desc: "Ergonomic executive chairs." },
            { icon: <FaBoxOpen size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Furniture", desc: "Bespoke design & manufacturing." },
            { icon: <FaHardHat size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Expert Installation", desc: "Professional assembly & placement." },
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mt-4">Furniture Services</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {["Custom Sofas","Sofa Sets","Sectional Sofas","Beds","Wardrobes","Cabinets","Home Furniture","Living Room","Dining Room","Bedroom Sets","Office Furniture","Office Desks","Office Chairs","Meeting Tables","Reception Desks","Custom Furniture","Furniture Repair","Furniture Assembly"].map((s, i) => (
      ...
      <section className="bg-[#f9f5f0] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 max-w-3xl mx-auto mb-10">Quality furniture, expert craftsmanship and professional service.</p>
      ...
      <section className="bg-gradient-to-br from-[#8A1538] to-[#5a0e24] py-20 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Need Furniture in Qatar?</h2>
