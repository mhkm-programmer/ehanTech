...
const Office_Tables = () => {
  return (
    <div className="font-sans text-gray-800 bg-white">
      <PageTitle title="Office Tables | Ehan Tech Qatar" />

      <ParallaxSection
        imagePath="https://8upload.com/image/685c9a9746ecf/IMG-20250625-WA0038.jpg"
        title="Office Tables Qatar"
        subTitle="Professional Workspaces. Premium Tables. Delivered Across Qatar."
      />

      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        <span className="text-[#8A1538] text-xs font-bold uppercase tracking-[0.25em]">Ehan Tech</span>
        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mt-4 mb-6 leading-tight">
          Premium Office Tables <span className="text-[#8A1538]">in Qatar</span>
        </h2>
        <p className="text-gray-500 text-lg max-w-4xl mx-auto leading-relaxed">
          Ehan Tech provides complete office table solutions in Qatar. We specialize in conference tables, meeting tables, reception desks, executive desks, workstations, and custom office tables for corporate offices and commercial spaces.
        </p>
      </section>
      ...
      <section className="bg-[#f9f5f0] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 text-center">
          {[
            { icon: <FaTable size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Conference Tables", desc: "Large tables for boardrooms & conference halls." },
            { icon: <FaChair size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Meeting Tables", desc: "Versatile tables for meeting rooms." },
            { icon: <FaBuilding size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Reception Desks", desc: "Stylish reception counters & welcome desks." },
            ...
            { icon: <FaCouch size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Workstations", desc: "Modular desks for open-plan offices." },
            { icon: <FaBoxOpen size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Side Tables", desc: "Practical side tables & accessory tables." },
            { icon: <FaRulerCombined size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Sizes", desc: "Tables made to your exact dimensions." },
            { icon: <FaTools size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Custom Design", desc: "Bespoke table designs for any space." },
            { icon: <FaHardHat size={36} className="mx-auto mb-4 text-[#8A1538]" />, title: "Expert Assembly", desc: "Professional assembly & placement." },
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mt-4">Office Table Services</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {["Conference Tables","Meeting Tables","Boardroom Tables","Reception Desks","Executive Desks","Computer Desks","Standing Desks","Workstations","Office Desks","Side Tables","Corner Desks","Breakout Tables","Training Tables","Cafeteria Tables","Custom Tables","Table Repair","Table Assembly","Office Fit-out"].map((s, i) => (
      ...
      <section className="bg-[#f9f5f0] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-500 max-w-3xl mx-auto mb-10">Quality office tables, expert craftsmanship and professional service.</p>
      ...
      <section className="bg-gradient-to-br from-[#8A1538] to-[#5a0e24] py-20 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Need Office Tables in Qatar?</h2>
